...
|网址|收费情况|登录备注|备注|
|:---:|:---:|:---:|:---|
|https://www.wenxiaobai.com/|大量免费(暂时没试出额度)+付费|登录后可保存聊天记录|模型仅有deepseek,未知训练参数量,智商较低,加强了防御,v3.2需将年龄修改为成年,但即使修改后所有模型都依然有概率拒绝请求|
|https://deepinfra.com/chat|无限免费+付费|无记忆,登录后收费|参数可调整,免费模型较少收费模型很全|
|https://www.techopens.com/|少量限次免费+付费|微信扫码登录|模型很全,最近貌似善心大发~~还是缺钱了~~,在b站布置了大量广告且基本上去除了所有模型的敏感词屏蔽|
